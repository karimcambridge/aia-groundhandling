...
<?php
	$cargoCompany = $_GET['cargoCompany'];
?>
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
					<strong> <?php echo $cargoCompany ?> Cargo Fees </strong>
			</div>
			<!-- /panel-heading -->
			<div class="panel-body">
				<table>
				<form class="form-inline" action="" method="post" id="cargoFees">
				  <div class="form-group">
				    <label class="col-sm- control-label">Import weight </label>
				    <div class="col-sm-12">
				  ...
				  <div class="form-group">
				    <label class="col-sm-1 control-label">Total Weight</label>
				    <div class="col-sm-12">
				      <input type="text" class="form-control" id="" name="" placeholder="120KG" />
				    </div>
				  </div>
				  <div class="form-group">
				    <label class="col-sm-1 control-label">Security Fee</label>
				    <div class="col-sm-12">
				  ...
				  <div class="form-group">
				    <label class="col-sm-2 control-label">DG Fees</label>
				    <div class="col-sm-12">
				      <input type="text" class="form-control" id="" name="" placeholder="175 per UNI #" />
				    </div>
				  </div>
				  <div class="form-group">
				    <label class="col-sm-2 control-label">Lcl/Rgnl</label>
				    <div class="col-sm-12">
				      <input type="text" class="form-control" id="" name="" placeholder="10.25 per mvmt" />
				    </div>
				  </div>
				  <div class="form-group">
				    <label class="col-sm-2 control-label">Int'l/Cmcl</label>
				    <div class="col-sm-12">
