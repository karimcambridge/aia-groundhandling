			...
			<div class="panel-body">
				...
				<form class="form-inline" action="" method="post" id="">
				  <div class="form-group">
				    <label for="startDate" class="col-sm-1 control-label">Import Weight</label>
				    <div class="col-sm-12">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-12">
				      <input type="text" class="form-control" id="" name="" placeholder="0.015 per kilo reg." />
				    </div>
				    <div class="col-sm-12">
				      <input type="text" class="form-control" id="" name="" placeholder="15% of s/chge (ref)" />
				    </div>
				  </div>
				  <div class="form-group">
