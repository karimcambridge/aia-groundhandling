		...
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-panel">
					<tag class="col-xs-1 col-sm-1 col-md-1 col-lg-1 control-label">Registration #<br><br></tag>
					...
					<table>
						...
						<tr>
							<td><tag class="col-xs-1 col-sm-1 col-md-1 col-lg-1 control-label">Airbridge</tag></td>
							<td><div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
